...
| --- | --- | --- |
| Host profile | RHEL 9 workstation VM with GUI | `../../06-runbooks/04-linux-workstation.md` |
...
- Baseline firewall model is documented in [`03-firewall-rules.md`](03-firewall-rules.md).
