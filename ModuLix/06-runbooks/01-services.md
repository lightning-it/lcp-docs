...
- Service manuals and design docs: `../07-services/`
...
| --- | --- | --- | --- |
| `01` Wunderbox | `../07-services/01-wunderbox/README.md` | `02-wunderbox.md` | `playbooks/stage-2b/12-wunderbox.yml`, `playbooks/services/01-wunderbox-rebuild.yml` |
| `02` AAP | `../07-services/02-aap/README.md` | `03-aap.md` | `playbooks/stage-2b/13-aap.yml`, `playbooks/services/02-aap-rebuild.yml` |
| `03` Linux Workstation | `../07-services/03-linux-workstation/README.md` | `04-linux-workstation.md` | `playbooks/stage-2b/11-workstation.yml` |
| `04` OCP | `../07-services/04-ocp/README.md` | `05-ocp.md` | `playbooks/stage-2c/container-platform-ocp4/prepare-ee.yml`, `20-ocp-install.yml`, `21-post-install.yml` |
