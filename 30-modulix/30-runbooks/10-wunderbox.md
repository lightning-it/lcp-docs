...
[`../20-services/10-wunderbox/`](../20-services/10-wunderbox/00-index.md):

- Architecture: [`../20-services/10-wunderbox/10-architecture.md`](../20-services/10-wunderbox/10-architecture.md)
- Requirements: [`../20-services/10-wunderbox/20-requirements.md`](../20-services/10-wunderbox/20-requirements.md)
- Firewall rules: [`../20-services/10-wunderbox/30-firewall-rules.md`](../20-services/10-wunderbox/30-firewall-rules.md)
...
[`automation.md`](../03-automation.md).

---

## Secrets

Shared secret handling conventions are documented in [`automation.md`](../03-automation.md).
