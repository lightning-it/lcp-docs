...
[`../20-services/40-ocp/`](../20-services/40-ocp/00-index.md):

- Architecture: [`../20-services/40-ocp/10-architecture.md`](../20-services/40-ocp/10-architecture.md)
- Requirements: [`../20-services/40-ocp/20-requirements.md`](../20-services/40-ocp/20-requirements.md)
- Firewall rules: [`../20-services/40-ocp/30-firewall-rules.md`](../20-services/40-ocp/30-firewall-rules.md)
